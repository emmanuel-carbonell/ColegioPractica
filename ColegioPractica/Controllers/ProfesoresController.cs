...
namespace ColegioPractica.Controllers
{
    public class ProfesoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Materia,Edad")] Profesores profesores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Materia,Edad")] Profesores profesores)
        {
            if (ModelState.IsValid)
            {
