...
namespace ColegioPractica.Controllers
{
    public class AlumnosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Matricula,Nombre,Carrera,Edad,Cuatrimestre")] Alumnos alumnos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Matricula,Nombre,Carrera,Edad,Cuatrimestre")] Alumnos alumnos)
        {
            if (ModelState.IsValid)
            {
